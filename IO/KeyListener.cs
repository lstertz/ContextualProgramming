...
// TODO :: Refer to https://stackoverflow.com/questions/604410/global-keyboard-capture-in-c-sharp-application
//          Better understand and clean-up the code for global key handling.
...
/// </summary>
[Behavior]
[Dependency<KeyInput>(Binding.Unique, Fulfillment.Existing, KeyInput)]
public class KeyListener
{
    ...
    /// </summary>
    /// <param name="keyInput">The record for submitted and unsubmitted input.</param>
    [Operation]
    [OnUpdate]
    public void ReadConsole(KeyInput keyInput)
    {
        /*
